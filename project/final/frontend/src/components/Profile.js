                            ...
                            <div className="block-for-mobile">
                                {
                                    nicknmaModal === true
                                    ?null
                                    :<div className="contents">myNickname</div>
                                }
                                    
                                {
                                    ...
                                    ?(
                                        <form className="nickname-form">
                                            <input className="nickname-input" placeholder="닉네임을 입력하세요"></input>
                                            <button className="save-button" onClick={()=>{setNickname(false)}}>저장</button>
                                        </form>
                                                ...
                                                <form>
                                                    <ul className="social-contents">
                                                        <li>
                                                            ...
                                                            <input className="social-input" placeholder="이메일을 입력하세요."></input>
                                                        </li>
                                                        <li>
                                                            ...
                                                            <input className="social-input" placeholder="Github계정을 입력하세요."></input>
                                                        </li>
                                                    </ul>
                                                </form>
                                        )
                                ...
                                </div>
                                {
                                    ...
                                    ?(
                                        <div className="button-wrapper">
                                            <button className="save-button" onClick={()=>{setSocialModal(false)}}>저장</button>
                                        </div>
                                    )
                                    :(
                                        <div className="edit-wrapper">
